                        ...
                        <form method="POST" action="#">
                            <div>
                                ...
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    <input id="name" name="name" placeholder="" type="text" required className=" bg-transparent block w-full px-3 py-2 border border-white rounded-full  focus:outline-none  transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            ...
                            <div className=' mt-3'>
                                <label htmlFor="email" className="block text-sm font-medium leading-5  text-white">Creator Contact number</label>
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    <input id="name" name="name" placeholder="" type="text" required className=" bg-transparent block w-full px-3 py-2 border border-white rounded-full  focus:outline-none  transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            ...
                            <div className=' mt-3'>
                                <label htmlFor="email" className="block text-sm font-medium leading-5  text-white">Social Links (if Any)</label>
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    <input id="name" name="name" placeholder="" type="text" required className=" bg-transparent block w-full px-3 py-2 border border-white rounded-full  focus:outline-none  transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
